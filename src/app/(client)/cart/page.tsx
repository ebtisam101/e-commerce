                  ...
                  <div className="lg:col-span-1">
                    <div className="hidden md:inline-block w-full bg-white p-6 rounded-lg border">
                      ...
                      <div className="space-y-4">
                        ...
                        <Button
                          className="w-full rounded-full font-semibold tracking-wide hoverEffect bg-shop_btn_dark_green/80  
                           hover:bg-shop_btn_dark_green cursor-pointer"
                          size="lg"
                          disabled={loading}
                ...
                <div className="md:hidden fixed bottom-0 left-0 w-full bg-white pt-2">
                  <div className="bg-white p-4 rounded-lg border mx-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <Button
                        className="w-full rounded-full font-semibold tracking-wide hoverEffect bg-shop_btn_dark_green/80 hover:bg-shop_btn_dark_green cursor-pointer"
                        size="lg"
                        disabled={loading}
                        onClick={handleCheckout}
                      >
